...
print(check_arrays([1,2,3,5], [1,2,3,4]))
print(check_arrays([1,2,3,4], [1,2,3,4])) # True
print(check_arrays([1,2,3,4], [1,4,5,6])) # False
print(check_arrays([1,2,3,4],[1,4,4,2])) # False
print(check_arrays([1,2,3,4],[1,4,3,2])) # True
print(check_arrays([1,2,3,4,5],[1,2,3,4])) # False
...
# find the count of each number in an array
# find the count of each number in array2
# 